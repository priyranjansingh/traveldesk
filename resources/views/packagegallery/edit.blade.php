...
<div class="box_p">
    <div class="titel_bar clear">
        <div class="p_titel">Update Package Gallery</div>
    ...
    <div class="from_p">
        ...
        <div class="row" >
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <img src="{{url('/images/package_gallery/'. $gallery->image_name) }}" height="70" width="70" alt="No Image Available">
        ...
        <div class="row">
            <div class="col-md-12 tar">
                ...
                {!! Form::submit('Update Package Gallery',['class'=>'btn_small bg_blue'])!!}
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".remove_gallery").click(function() {
                ...
                $.ajax({
                    method: "GET",
                    url: '<?php echo url('removepackageGallery/'); ?>/'+id,
