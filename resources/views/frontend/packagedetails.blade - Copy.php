...
<!--Search box--> 
      ...
      <div class="wraper">
        ...
        <ul class="page-breadcrumb">
                    ...
                    <li><a href="#" id="bck"><i class="fa"></i>Holidays in {{session('going_to')}}</a></li>
...
<div class="wraper detail_p"> 
    ...
    <div class="row">
		...
		<div class="col-3">
          ...
          <p>
          @if(!empty($city_nights))
            @foreach ($city_nights as $nights)
                 {{$nights->city_name}} - {{ $nights->night_count }} Nights<br />
            @endforeach
          @endif
          </p>
           </div> 
    ...
    <div class="p_itinerary ">
    	...
    	<div class="col-11">
        	...
        	<div class="sedule_con">
                    <?php $day=1;?>
                @foreach ($package_days as $days)
            	<div class="a_title">
                	<div class="place">{{$days->city_name}}</div><div class="p_from">
                            <?php $to_day=$day+$days->day_count-1;?>
                            {{ $days->day_count == 1 ? 'Day - '.$day : 'From: DAY-'.$day. ' to DAY-'.$to_day }}
                ...
                <div class="a_con">  
                    ...
                    $state_name='';
                    ?>
                    @foreach ($package_details[$days->city_id] as $package_detail) 
                    ...
                    <div class="row">
                    	<div class="col-3">
                            ...
                            <h6>HOTEL</h6>
                            @if($loop_count==1)
                            <p class="ithotel">CHECK IN FOR {{$package_nights[$days->city_id]}} NIGHTS</p>
                            @endif
                            @if($loop_count==$days->day_count)
                            <p class="ithotel">CHECK OUT</p>
                            @endif
                            </div>
                        </div>
                        <div class="col-9">
...
<div class="white-popup mfp-hide" id="myModal">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
          	<div class="col-8">
            	<h5><i class="fa fa-phone round"></i> <strong>Call 1860 200 1800</strong></h5>
