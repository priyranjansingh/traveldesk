        ...
        <div class="row">    
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::textarea('terms',$cms[0],['class'=>'t_area','id'=>'terms'])!!}               
                    </div>
                </div>
            </div>                
        </div>            
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::textarea('inclusions',$cms[1],['class'=>'t_area','id'=>'inclusions'])!!}                   
                    </div>
                </div> 
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::textarea('exclusions',$cms[2],['class'=>'t_area','id'=>'exclusions'])!!}                    
                    </div>
                </div> 
            </div>
        </div>  
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8"> 
                        {!! Form::textarea('cancellation_policy',$cms[3],['class'=>'t_area','id'=>'cancellation_policy'])!!}                    
                    </div>
                </div> 
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::textarea('payment_policy',$cms[4],['class'=>'t_area','id'=>'payment_policy'])!!}                   
                    </div>
                </div> 
            </div>
       ...
       <div class="row">    
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('class_id', $tour_classes,'',['class'=>"chosen-select-no-single"]) !!}
                    </div>
                </div>                                        
            </div>                
        </div>
        <div class="row"> 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('inclusion_id[]', $tour_inclusions,'',['class'=>"chosen-select-no-single",'multiple'=>"multiple"]) !!}
                    </div>
                </div>                                        
            </div> 
        </div>
